...
#define ZIXI_SERVICE_PROP_PASSWORD			"zixi_password"
#define ZIXI_SERVICE_PROP_ENABLE_BONDING	"zixi_enable_bonding"
#define ZIXI_SERVICE_PROP_USE_ENCODER_FEEDBACK "zixi_encoder_feedback"
...
extern unsigned int ZIXI_LATENCIES[];
extern const char * ZIXI_LATENCIES_STR[];
extern unsigned int ZIXI_LATENCY_COUNT;
extern const char * ENCRYPTION_STR[];
extern unsigned int ENCRYPTION_COUNT;
